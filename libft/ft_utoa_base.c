...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/12 11:32:28 by bcastelo          #+#    #+#             */
/*   Updated: 2022/11/12 11:32:31 by bcastelo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_utoa_base_r(unsigned int n, char *number,
...
char	*ft_utoa_base(int n, char *base)
{
	...
	if (base_size < 2)
		return (NULL);
	number = ft_calloc(34, sizeof(char));
	if (!number)
		return (NULL);
